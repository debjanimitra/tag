...
public enum MessageContent implements Serializable {
	USER, DATA, NOTIFICATION, USERID, DONE, NEWUSERID, ERRORHANDSHAKE_UNKNOWNUSER, ERRORHANDSHAKE_NONUNIQUEUSER, ERRORHANDSHAKE_NOUSER, ERROR_RECEIVE_TAGALREADYEXISTS, ERROR_RECEIVE_INVALIDDATA
}
